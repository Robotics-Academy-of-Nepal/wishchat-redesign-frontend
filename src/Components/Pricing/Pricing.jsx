...
import basic from './images/Basic Plan.png';
import basicmessage from './images/basicmessage.png';
import month from './images/Group 22.png';
import getstarted from './images/Group 26.png';
import enterprise from './images/Group 29.png';
    ...
    <div className='container mx-auto px-4 py-16'>
      ...
      <div className='flex flex-col md:flex-row justify-between gap-4 items-center mb-[70px]'>
        ...
        <div className='flex justify-center items-center gap-2 bg-gray-100 p-2 rounded-3xl'>
          <button className='bg-blue-600 text-white rounded-3xl px-4 py-2'>Monthly</button>
          <button className='bg-gray-100 text-black rounded-3xl px-3 py-1'>Annual</button>
          <button className='bg-black text-white rounded-3xl px-3 py-1'>Save 20%</button>
        </div>
      </div>
      ...
      <div className='mt-12 px-4'>
        <div className='border-2 py-9 flex flex-col md:flex-row items-center justify-between rounded-3xl p-6 border-gray-300 shadow-lg'>
          <img src={enterprise} alt='Enterprise Plan' className='h-20 mb-4 md:mb-0' />
          <button>
            <img src={getstarted} alt='Get Started' className='h-14' />
          </button>
        </div>
